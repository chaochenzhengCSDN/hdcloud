...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.ty.HdBankTenantTyServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbanktenant/ty")
@Api(value = "hdbanktenant", tags = "bank_account管理")
public class HdBankTenantTyController {

    private final HdBankTenantTyServiceImpl hdBankTenantTyService;
    ...
    public R getHdBankTenantPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankTenantTyService.page(page, queryWrapper));
    }
    ...
    public List<HdBankTenant> getHdBankTenantList(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        queryWrapper.eq("tenant_id",tenantId);
        return hdBankTenantTyService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankTenantTyService.getById(id));
    }
    ...
    public HdBankTenant selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankTenantTyService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public R save(@RequestBody HdBankTenant hdBankTenant) {
        ...
        return R.ok(hdBankTenantTyService.save(hdBankTenant));
    }
    ...
    public R updateById(@RequestBody HdBankTenant hdBankTenant) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        boolean b = hdBankTenantTyService.updateById(hdBankTenant);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankTenantTyService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        try {
            return R.ok(hdBankTenantTyService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankTenantTyService.remove(wrapper));
    }
    ...
    public List<String> selectDistinctString(String str, String param, String val) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return hdBankTenantTyService.selectDistinctString(str, param, val);
    }
    ...
    public R addList(@RequestBody List<HdBankTenant> list) {
        ...
        boolean b = hdBankTenantTyService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
