...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.cambodia.HdBankRecordCambodiaServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbankrecord/cambodia")
@Api(value = "hdbankrecord", tags = "bank_account管理")
public class HdBankRecordCambodiaController {

    private final HdBankRecordCambodiaServiceImpl hdBankRecordService;
    ...
    public R getHdBankRecordPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankRecordService.page(page, queryWrapper));
    }
    ...
    public List<HdBankRecord> getHdBankRecordList(@RequestParam Map<String, Object> map) {
        ...
        queryWrapper.eq("tenant_id", tenantId);
        queryWrapper.orderByDesc("num", "account_date");
        return hdBankRecordService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return R.ok(hdBankRecordService.getById(id));
    }
    ...
    public HdBankRecord selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankRecordService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public R save(@RequestBody HdBankRecord hdBankRecord) {
        ...
        return R.ok(hdBankRecordService.save(hdBankRecord));
    }
    ...
    public R updateById(@RequestBody HdBankRecord hdBankRecord) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        boolean b = hdBankRecordService.updateById(hdBankRecord);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return R.ok(hdBankRecordService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        try {
            return R.ok(hdBankRecordService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankRecordService.remove(wrapper));
    }
    ...
    public R addList(@RequestBody List<HdBankRecord> list) {
        ...
        boolean b = hdBankRecordService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
    ...
    public List<HdBankRecord> getHdBankRecordList2(@RequestParam Map<String, Object> params) {
        ...
        List<HdBankRecord> list = hdBankRecordService.getHdBankRecordList(moneyStart, moneyEnd, companyId, startTime, endTime,
    ...
    public List<HdBankRecord> getAllBankRecord2(@RequestParam Map<String, Object> params) {
        ...
        return hdBankRecordService.getAllBankRecord(moneyStart, moneyEnd, companyName, startTime, endTime,
    ...
    public Map<String, Object> otherVal(@RequestParam Map<String, Object> params) {
        ...
        String total = hdBankRecordService.otherVal(moneyStart, moneyEnd, companyName, startTime, endTime,
                tenantId, params, num, accountId);
