...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.ty.HdBankRecordTyServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbankrecord/ty")
@Api(value = "hdbankrecord", tags = "bank_account管理")
public class HdBankRecordTyController {

    private final HdBankRecordTyServiceImpl hdBankRecordTyService;
    ...
    public R getHdBankRecordPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankRecordTyService.page(page, queryWrapper));
    }
    ...
    public List<HdBankRecord> getHdBankRecordList(@RequestParam Map<String, Object> map) {
        ...
        queryWrapper.eq("tenant_id",tenantId);
        queryWrapper.orderByDesc("num", "account_date");
        return hdBankRecordTyService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankRecordTyService.getById(id));
    }
    ...
    public HdBankRecord selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankRecordTyService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public R save(@RequestBody HdBankRecord hdBankRecord) {
        ...
        return R.ok(hdBankRecordTyService.save(hdBankRecord));
    }
    ...
    public R updateById(@RequestBody HdBankRecord hdBankRecord) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        boolean b = hdBankRecordTyService.updateById(hdBankRecord);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankRecordTyService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        try {
            return R.ok(hdBankRecordTyService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankRecordTyService.remove(wrapper));
    }
    ...
    public R addList(@RequestBody List<HdBankRecord> list) {
        ...
        boolean b = hdBankRecordTyService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
    ...
    public List<HdBankRecord> getAllBankRecord(@RequestParam Map<String, Object> params) {
        ...
        List<HdBankRecord> list = hdBankRecordTyService.getHdBankRecordList(moneyStart, moneyEnd, companyId, startTime, endTime,
    ...
    public List<HdBankRecord> getHdBankRecordList2(@RequestParam Map<String, Object> params) {
        ...
        return hdBankRecordTyService.getAllBankRecord(moneyStart, moneyEnd, companyName, startTime, endTime,
    ...
    public Map<String, Object> otherVal(@RequestParam Map<String, Object> params) {
        ...
        String total = hdBankRecordTyService.otherVal(moneyStart, moneyEnd, companyName, startTime, endTime,
                tenantId, params, num, accountId);
