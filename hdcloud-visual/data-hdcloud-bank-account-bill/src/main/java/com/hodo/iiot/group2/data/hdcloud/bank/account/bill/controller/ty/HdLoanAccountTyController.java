...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.ty.HdLoanAccountTyServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdloanaccount/ty")
@Api(value = "hdloanaccount", tags = "管理")
public class HdLoanAccountTyController {

    private final HdLoanAccountTyServiceImpl hdLoanAccountService;
