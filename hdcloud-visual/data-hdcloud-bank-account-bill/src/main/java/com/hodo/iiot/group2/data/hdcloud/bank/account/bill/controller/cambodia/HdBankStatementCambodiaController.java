...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.cambodia.HdBankStatementCambodiaServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbankstatementty/cambodia")
@Api(value = "hdbankstatement", tags = "bank_account管理")
public class HdBankStatementCambodiaController {

    private final HdBankStatementCambodiaServiceImpl hdBankStatementService;
    ...
    public R getHdBankStatementPage(@RequestParam Map<String, Object> map) {
        ...
        Object ob = hdBankStatementService.page(page, queryWrapper);
        return R.ok(ob);
    }
    ...
    public R getHdBankStatementAll(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankStatementService.list(queryWrapper));
    }
    ...
    public List<String> getSheetIds() {
        ...
        return hdBankStatementService.getSheetIds(tenantId);
    }
    ...
    public List<String> getRIds() {
        ...
        return hdBankStatementService.getRIds(tenantId);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return R.ok(hdBankStatementService.getById(id));
    }
    ...
    public HdBankStatement selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankStatementService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
...
//
//        return R.ok(hdBankStatementService.save(hdBankStatementTy));
//    }
    ...
    public R updateById(@RequestBody HdBankStatement hdBankStatement) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        boolean b = hdBankStatementService.updateById(hdBankStatement);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return R.ok(hdBankStatementService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        try {
            return R.ok(hdBankStatementService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankStatementService.remove(wrapper));
    }
    ...
    public List<HdBankStatement> getBankStatementListBySql(@RequestParam Map<String, Object> map) {
        ...
        List list = hdBankStatementService.getBankAccountListBySql(moneyStart, moneyEnd, startTime, endTime,
    ...
    public List<HdBankStatement> getAllBankAccountBySql(@RequestParam Map<String, Object> params) {
        ...
        List list = hdBankStatementService.getAllBankAccountBySql(moneyStart, moneyEnd, startTime, endTime,
    ...
    public Map<String, Object> getOtherVal(@RequestParam Map<String, Object> params) {
        ...
        Map<String, Object> map = hdBankStatementService.getOtherVal(moneyStart, moneyEnd, startTime, endTime, params,
    ...
    public String getBalance(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleParamsClean(map);
        return hdBankStatementService.getBalance(tenantId.toString(), accountId, accountDate, by2);
    }
    ...
    public List<Map> getAllBalance(@RequestParam Map<String, Object> map) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        Integer tenantId = TenantContextHolder.getTenantId();
        String accountIds = hdBankStatementService.getAllAccountId();
        List<String> accountList = Arrays.asList(accountIds.split(","));
        String accountDate = jjUtil.handleParams(map, "accountDate");
        String by2 = jjUtil.handleParams(map, "by2");
        jjUtil.handleParamsClean(map);
        return hdBankStatementService.getAllBalance(tenantId, accountList, accountDate, Integer.parseInt(by2));
    }
    ...
    public synchronized BigDecimal selectMaxNo(@RequestParam(required = false) String accountDate) {
        ...
        Integer tenantId = TenantContextHolder.getTenantId();
        if (accountDate == null) {
            return hdBankStatementService.selectMaxNo(tenantId);
        } else {
            return hdBankStatementService.selectMaxNoByDate(accountDate, tenantId);
        }
    }
    ...
    public synchronized R addList(@RequestBody List<HdBankStatement> list) {
        ...
        for (HdBankStatement hdBankStatementTy :
                list) {
//           BigDecimal bd =  hdBankStatementService.selectMaxNo(tenantId);
...
//            hdBankStatementTy.setNo(bd);
        ...
        boolean b = hdBankStatementService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
    ...
    public boolean deleteBatch(List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return hdBankStatementService.removeByIds(list);
    }
    ...
    public String getBankReportBalance(@RequestParam String startTime, @RequestParam String tenantId,
        ...
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return hdBankStatementService.getBankReportBalance(startTime, tenantId, bankAccountId);
    }
    ...
    public String getComReportBalance(@RequestParam String startTime, @RequestParam String tenantId,
        ...
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_CAMBODIA);
        return hdBankStatementService.getComReportBalance(startTime, tenantId, companyId);
    }
