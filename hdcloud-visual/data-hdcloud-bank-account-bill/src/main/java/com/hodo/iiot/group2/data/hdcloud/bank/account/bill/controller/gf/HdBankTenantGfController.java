...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.gf.HdBankTenantGfServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbanktenant/gf")
@Api(value = "hdbanktenant", tags = "bank_account管理")
public class HdBankTenantGfController {

    private final HdBankTenantGfServiceImpl hdBankTenantGfService;
    ...
    public R getHdBankTenantPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankTenantGfService.page(page, queryWrapper));
    }
    ...
    public List<HdBankTenant> getHdBankTenantList(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        queryWrapper.eq("tenant_id",tenantId);
        return hdBankTenantGfService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        return R.ok(hdBankTenantGfService.getById(id));
    }
    ...
    public HdBankTenant selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankTenantGfService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public R save(@RequestBody HdBankTenant hdBankTenant) {
        ...
        return R.ok(hdBankTenantGfService.save(hdBankTenant));
    }
    ...
    public R updateById(@RequestBody HdBankTenant hdBankTenant) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        boolean b = hdBankTenantGfService.updateById(hdBankTenant);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        return R.ok(hdBankTenantGfService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        try {
            return R.ok(hdBankTenantGfService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankTenantGfService.remove(wrapper));
    }
    ...
    public List<String> selectDistinctString(String str, String param, String val) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        return hdBankTenantGfService.selectDistinctString(str, param, val);
    }
    ...
    public R addList(@RequestBody List<HdBankTenant> list) {
        ...
        boolean b = hdBankTenantGfService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
