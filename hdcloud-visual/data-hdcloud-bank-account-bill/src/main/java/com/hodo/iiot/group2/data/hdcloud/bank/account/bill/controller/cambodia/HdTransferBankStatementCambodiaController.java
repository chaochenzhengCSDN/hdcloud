...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.cambodia.HdTransferBankStatementCambodiaServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdtransferbankstatement/cambodia")
@Api(value = "hdtransferbankstatement", tags = "bank_account管理")
public class HdTransferBankStatementCambodiaController {

    private final HdTransferBankStatementCambodiaServiceImpl hdTransferBankStatementService;
