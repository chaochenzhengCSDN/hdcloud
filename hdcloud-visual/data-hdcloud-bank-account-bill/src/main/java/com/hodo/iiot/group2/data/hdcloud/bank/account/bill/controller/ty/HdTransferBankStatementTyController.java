...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.ty.HdTransferBankStatementTyServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdtransferbankstatement/ty")
@Api(value = "hdtransferbankstatement", tags = "bank_account管理")
public class HdTransferBankStatementTyController {

    private final HdTransferBankStatementTyServiceImpl hdTransferBankStatementService;
