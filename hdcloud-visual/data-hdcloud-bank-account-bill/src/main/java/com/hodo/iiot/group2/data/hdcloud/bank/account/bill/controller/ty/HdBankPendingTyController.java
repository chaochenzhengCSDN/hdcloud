...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.ty.HdBankPendingTyServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbankpending/ty")
@Api(value = "hdbankpending", tags = "bank_account管理")
public class HdBankPendingTyController {

    private final HdBankPendingTyServiceImpl hdBankPendingTyService;
    ...
    public R getHdBankPendingPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankPendingTyService.page(page, queryWrapper));
    }
    ...
    public List<HdBankPending> getHdBankPendingList(@RequestParam Map<String, Object> map) {
        ...
        queryWrapper.eq("tenant_id",tenantId);
        queryWrapper.orderByDesc("account_date", "company_name");
        return hdBankPendingTyService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankPendingTyService.getById(id));
    }
    ...
    public HdBankPending selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankPendingTyService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public List<HdBankPending> getBankPendingList(@RequestParam  Map<String, Object> params) {
        ...
        return hdBankPendingTyService.getBankPendingList(moneyStart, moneyEnd, startTime, endTime,
    ...
    public Map<String, Object> getOtherVal(@RequestParam Map<String, Object> params) {
        ...
        Map map = hdBankPendingTyService.getOtherVal(moneyStart, moneyEnd, startTime,
    ...
    public List<HdBankPending> getAllBankPending(@RequestParam @ApiParam(value = "参数名称(subjects,page,limit,dateStart,dataEnd," +
        ...
        String moneyStart = jjUtil.handleParams(params, "moneyStart");
        String moneyEnd = jjUtil.handleParams(params, "moneyEnd");
        return hdBankPendingTyService.getAllBankPending(moneyStart, moneyEnd, startTime, endTime, tenantId, params);
    }
    ...
    public R save(@RequestBody HdBankPending hdBankPending) {
        ...
        return R.ok(hdBankPendingTyService.save(hdBankPending));
    }
    ...
    public R updateById(@RequestBody HdBankPending hdBankPending) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        boolean b = hdBankPendingTyService.updateById(hdBankPending);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        return R.ok(hdBankPendingTyService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_TY);
        try {
            return R.ok(hdBankPendingTyService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankPendingTyService.remove(wrapper));
    }
...
//        System.out.println("处理完");
        boolean b = hdBankPendingTyService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
