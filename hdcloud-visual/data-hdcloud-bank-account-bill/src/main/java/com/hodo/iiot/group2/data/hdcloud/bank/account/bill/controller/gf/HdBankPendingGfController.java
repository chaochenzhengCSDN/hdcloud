...
import com.hodo.iiot.group2.data.hdcloud.bank.account.bill.service.impl.gf.HdBankPendingGfServiceImpl;
...
@RestController
@AllArgsConstructor
@RequestMapping("/hdbankpending/gf")
@Api(value = "hdbankpending", tags = "bank_account管理")
public class HdBankPendingGfController {

    private final HdBankPendingGfServiceImpl hdBankPendingGfService;
    ...
    public R getHdBankPendingPage(@RequestParam Map<String, Object> map) {
        ...
        return R.ok(hdBankPendingGfService.page(page, queryWrapper));
    }
    ...
    public List<HdBankPending> getHdBankPendingList(@RequestParam Map<String, Object> map) {
        ...
        queryWrapper.eq("tenant_id",tenantId);
        queryWrapper.orderByDesc("account_date", "company_name");
        return hdBankPendingGfService.list(queryWrapper);
    }
    ...
    public R getById(@PathVariable("id") String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        return R.ok(hdBankPendingGfService.getById(id));
    }
    ...
    public HdBankPending selectOne(@RequestParam Map<String, Object> map) {
        ...
        jjUtil.handleAllParamsToWrapper(map, queryWrapper);
        try {
            return hdBankPendingGfService.getOne(queryWrapper);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public List<HdBankPending> getBankPendingList(@RequestParam  Map<String, Object> params) {
        ...
        return hdBankPendingGfService.getBankPendingList(moneyStart, moneyEnd, startTime, endTime,
    ...
    public Map<String, Object> getOtherVal(@RequestParam Map<String, Object> params) {
        ...
        Map map = hdBankPendingGfService.getOtherVal(moneyStart, moneyEnd, startTime,
    ...
    public List<HdBankPending> getAllBankPending(@RequestParam @ApiParam(value = "参数名称(subjects,page,limit,dateStart,dataEnd," +
        ...
        String moneyStart = jjUtil.handleParams(params, "moneyStart");
        String moneyEnd = jjUtil.handleParams(params, "moneyEnd");
        return hdBankPendingGfService.getAllBankPending(moneyStart, moneyEnd, startTime, endTime, tenantId, params);
    }
    ...
    public R save(@RequestBody HdBankPending hdBankPending) {
        ...
        return R.ok(hdBankPendingGfService.save(hdBankPending));
    }
    ...
    public R updateById(@RequestBody HdBankPending hdBankPending) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        boolean b = hdBankPendingGfService.updateById(hdBankPending);
        if (b) {
            return R.ok(b);
        } else {
            return R.failed(b);
    ...
    public R removeById(@PathVariable String id) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        return R.ok(hdBankPendingGfService.removeById(id));
    }
    ...
    public R removeByIds(@RequestBody List<String> list) {
        DynamicDataSourceContextHolder.setDataSourceType(DataSourceId.BANK_ACCOUNT_GF);
        try {
            return R.ok(hdBankPendingGfService.removeByIds(list));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public R removeById(@RequestBody Map<String, Object> map) {
        ...
        return R.ok(hdBankPendingGfService.remove(wrapper));
    }
...
//        System.out.println("处理完");
        boolean b = hdBankPendingGfService.saveBatch(list);
        if (b) {
            return R.ok("true");
        } else {
